...
export function Footer() {
    return (
        <div className="fixed left-0 bottom-0 w-full bg-white flex p-4 justify-between">
            <div>
                Follow us on: {" "}
                <Icon name="twitter" className="cursor-pointer" onClick={() => window.open(TWITTER_URL, '_blank').focus()} />
                <Icon name="discord" className="cursor-pointer" onClick={() => window.open(DISCORD_URL, '_blank').focus()} />
            </div>
